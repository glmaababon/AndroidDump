...
public class DBAdapter {
	...
	private static final String DATABASE_CREATE ="create table vips (_id integer primary key autoincrement, "
	...
	public long getID(String str) {
	    long res;
	    Cursor cursor = db.query(DATABASE_TABLE, new String[] { KEY_ROWID,}, KEY_NAME + "=?", new String[] { str }, null, null, null, null);
	    if ((cursor != null) && (cursor.getCount() > 0)) {
	        cursor.moveToFirst();
	        res = cursor.getLong(cursor.getColumnIndex(KEY_ROWID));
	    }
	    else {
	        res = -1;
	    }
	...
	{  Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,KEY_NAME, KEY_EMAIL, KEY_NUMBER}, KEY_ROWID + "=" + rowId, null,null, null, null, null);
